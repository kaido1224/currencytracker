...
class Migration(migrations.Migration):
    def populate_currency(apps, schema_editor):
        ...
        currency.objects.bulk_create([
            ...
            currency(book=book_2, page=1, row=3, column=3, currency="Cents",
            ...
            currency(book=book_2, page=2, row=1, column=2, currency="Cents",
            ...
            currency(book=book_2, page=2, row=3, column=1, currency="Stotinka",
                     value=1, type="Coin", country="BG"),
