...
class Migration(migrations.Migration):
    def populate_currency(apps, schema_editor):
        ...
        currency.objects.bulk_create([
            ...
            currency(book=book_1, page=2, row=1, column=1, currency="Cents",
            ...
            currency(book=book_1, page=3, row=2, column=1, currency="Centimes",
                     value=5, type="Coin", country="FR"),
            currency(book=book_1, page=3, row=2, column=2, currency="Stotinka",
            ...
            currency(book=book_1, page=4, row=3, column=4, currency="Cents",
                     value=1, type="Coin", country="CA"),
            currency(book=book_1, page=4, row=3, column=5, currency="Cents",
                     value=1, type="Coin", country="GB"),
            currency(book=book_1, page=4, row=4, column=1, currency="Cents",
            ...
            currency(book=book_1, page=4, row=4, column=5, currency="Franc",
                     value=1, type="Coin", country="BE"),
            currency(book=book_1, page=4, row=5, column=1, currency="Cents",
                     value=5, type="Coin", country="CA"),
            ...
            currency(book=book_1, page=4, row=6, column=2, currency="Pfennig",
                     value=1, type="Coin", country="DE"),
            currency(book=book_1, page=4, row=6, column=3, currency="Cents",
            ...
            currency(book=book_2, page=1, row=1, column=2, currency="Cents",
                     value=20, type="Coin", country="HK"),
            currency(book=book_2, page=1, row=1, column=3, currency="Cents",
            ...
            currency(book=book_2, page=1, row=1, column=5, currency="Won",
                     value=10, type="Coin", country="KR"),
            currency(book=book_2, page=1, row=3, column=1, currency="Jiao",
                     value=1, type="Coin", country="CN"),
            currency(book=book_2, page=1, row=3, column=2, currency="Sen",
                     value=10, type="Coin", country="MY"),
            currency(book=book_2, page=1, row=3, column=3, currency="Sen",
                     value=20, type="Coin", country="MY"),
            currency(book=book_2, page=1, row=3, column=4, currency="Cents",
                     value=5, type="Coin", country="SG"),
            currency(book=book_2, page=1, row=3, column=5, currency="Rupiah",
                     value=50, type="Coin", country="ID"),
            currency(book=book_2, page=1, row=4, column=1, currency="Rupee",
                     value=25, type="Coin", country="LK"),
            currency(book=book_2, page=1, row=4, column=2, currency="So'm",
                     value=50, type="Coin", country="UZ"),
            currency(book=book_2, page=1, row=4, column=3, currency="Tenge",
                     value=1, type="Coin", country="KZ"),
            currency(book=book_2, page=1, row=4, column=4, currency="Tyiyn",
                     value=50, type="Coin", country="KG"),
            currency(book=book_2, page=1, row=4, column=5, currency="Tetri",
                     value=2, type="Coin", country="GE"),
            currency(book=book_2, page=2, row=1, column=1, currency="Kopek",
                     value=1, type="Coin", country="RU"),
            currency(book=book_2, page=2, row=1, column=2, currency="Shilling",
                     value=1, type="Coin", country="SO"),
            currency(book=book_2, page=2, row=1, column=3, currency="Cents",
                     value=10, type="Coin", country="ZA"),
            currency(book=book_2, page=2, row=1, column=4, currency="Franc",
